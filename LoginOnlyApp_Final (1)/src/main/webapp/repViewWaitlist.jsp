...
<html>
<head><title>Flight Waiting List</title></head>
<body>

<h2>Flight Waiting List Lookup</h2>

<form action="WaitlistServlet" method="post">
    Enter Flight ID: <input type="number" name="flight_id" required>
...
<table border="1">
<tr>
    <th>User ID</th><th>Username</th><th>First Name</th><th>Last Name</th><th>Time Added</th>
</tr>
