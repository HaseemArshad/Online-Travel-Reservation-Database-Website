...
<tr>
    ...
    <th>Date</th><th>Dep Time</th><th>Arr Time</th>
    <th>Price</th><th>Stops</th><th>Capacity</th><th>Actions</th>
</tr>
<%
...
<form action="FlightServlet" method="post">
    ...
    Flight ID: <input type="text" name="flight_id" required><br>
    ...
    Stops: <input type="number" name="stops"><br>
...
<form action="FlightServlet" method="post">
    ...
    Flight ID: <input type="text" name="flight_id" value="<%= request.getAttribute("flight_id") %>" readonly><br>
    Airline: <input type="text" name="airline" value="<%= request.getAttribute("airline") %>"><br>
    From Airport: <input type="text" name="from_airport" value="<%= request.getAttribute("from_airport") %>"><br>
    To Airport: <input type="text" name="to_airport" value="<%= request.getAttribute("to_airport") %>"><br>
    Departure Date: <input type="date" name="departure_date" value="<%= request.getAttribute("departure_date") %>"><br>
    Departure Time: <input type="time" name="departure_time" value="<%= request.getAttribute("departure_time") %>"><br>
    Arrival Time: <input type="time" name="arrival_time" value="<%= request.getAttribute("arrival_time") %>"><br>
    Price: <input type="number" step="0.01" name="price" value="<%= request.getAttribute("price") %>"><br>
    Stops: <input type="number" name="stops" value="<%= request.getAttribute("stops") %>"><br>
    Capacity: <input type="number" name="capacity" value="<%= request.getAttribute("capacity") %>"><br>
