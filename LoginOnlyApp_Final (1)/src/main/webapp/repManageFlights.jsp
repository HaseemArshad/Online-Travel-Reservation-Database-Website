...
<div class="container">
            ...
            <tr>
                ...
                <td>
                    <form action="FlightServlet" method="post" style="display:inline;">
                        ...
                        <input type="hidden" name="flight_number" value="<%= row[0] %>">
                        ...
                        <input type="hidden" name="arrival_date" value="<%= row[5] %>">
                        <input type="hidden" name="departure_time" value="<%= row[6] %>">
                        <input type="hidden" name="arrival_time" value="<%= row[7] %>">
                        <input type="hidden" name="price" value="<%= row[8] %>">
                        <input type="hidden" name="stops" value="<%= row[9] %>">
                        <input type="hidden" name="capacity" value="<%= row[10] %>">
    ...
    <form action="FlightServlet" method="post">
        ...
        Flight Number: <input type="text" name="flight_number" required><br><br>
        ...
        Arrival Date: <input type="date" name="arrival_date"><br><br>
    ...
    <% if ("true".equals(String.valueOf(request.getAttribute("edit")))) { %>
        ...
        <form action="FlightServlet" method="post">
            ...
            Flight Number: <input type="text" name="flight_number" value="<%= request.getAttribute("flight_number") %>" readonly><br><br>
            ...
            Arrival Date: <input type="date" name="arrival_date" value="<%= request.getAttribute("arrival_date") %>"><br><br>
